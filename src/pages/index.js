    ...
    <div className="flex items-center justify-center h-screen max-w-3xl mx-auto px-10">
      <div>
        ...
        <div>
            ...
            <div>
              <div>
                  <li>I really enjoy gravel-biking. All of my activities are uploaded on <Link href="https://www.strava.com/athletes/98819139" className="text-blue-600 hover:underline">Strava </Link>. I try to hit 100km/ week.</li>
